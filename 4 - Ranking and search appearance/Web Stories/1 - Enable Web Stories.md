...
[Video](https://www.youtube.com/watch?v=uzRHCXKQZY4)
...
2. All Web Stories must be canonical. Make sure that each Web Story has a [`link rel="canonical"`](https://amp.dev/documentation/guides-and-tutorials/optimize-and-measure/discovery/) to itself. For example: `<link rel="canonical" href="https://www.example.com/url/to/webstory.html">`
   ...
   > [!NOTE]
   > If there are multiple versions of the same story in different languages, make sure to [tell Google about localized versions](https://developers.google.com/search/docs/specialty/international/localized-versions).

3. Check that the Web Story URL isn't [blocked from Googlebot](https://developers.google.com/search/docs/crawling-indexing) in your robots.txt file or by a `noindex` tag.
