...
| Required properties |                                                                                                                                                                                                                                                                                                          |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cssSelector`       | `https://schema.org/Text` Addresses content in the annotated pages (such as class attribute). Use either `cssSelector` or `xPath`; don't use both. For example: `"speakable": { "@type": "SpeakableSpecification", "cssSelector": [ ".headline", ".summary" ] }`                                         |
| `xPath`             | `https://schema.org/Text` Addresses content using xPaths (assuming an XML view of the content). Use either `cssSelector` or `xPath`; don't use both. For example: `"speakable": { "@type": "SpeakableSpecification", "xPath": [ "/html/head/title", "/html/head/meta[@name='description']/@content" ] }` |
...
**Problem**: You can't trigger your content
