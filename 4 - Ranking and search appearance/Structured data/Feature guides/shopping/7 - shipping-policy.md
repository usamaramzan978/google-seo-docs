...
- We recommend placing shipping policy information on a single page on your site that describes the shipping policy of your business. You don't need to include it on every page of your site. Include the `ShippingService` structured data type under the `Organization` structured data type. For more information, see [Organization markup](https://developers.google.com/search/docs/appearance/structured-data/organization).
- If you have a non-standard shipping policy for a specific product, specify the `OfferShippingDetails` structured data type directly under the `Offer` structured data type. Note that the properties supported for offer-level shipping policies are a subset of the properties supported for organization-level shipping policies. See [merchant listing markup](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) for the subset of properties that are supported for product-level shipping policies.
...
| Recommended properties |                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `businessDays`         | `https://schema.org/DayOfWeek` The days of the week when received orders are processed, if applicable.                                                                                                                                                                                                                                                                                                        |
| `cutoffTime`           | `https://schema.org/Time` The time after which orders received on a day are not processed that same day, if applicable. For orders processed after cutoff time, one day gets added to the delivery time estimate. The time is indicated using the ISO-8601 time format, for example "23:30:00-05:00" represents 6:30 pm Eastern Standard Time (EST) which is 5 hours behind Coordinated Universal Time (UTC). |
| `duration`             | `https://schema.org/QuantitativeValue` The delay between the receipt of an order and the goods leaving the warehouse, if applicable.                                                                                                                                                                                                                                                                          |
...
| `minValue`             | `https://schema.org/Number` The minimum number of days, if applicable. The value must be a non-negative, whole number.                                                                 |
| `unitCode`             | `https://schema.org/Text` The units of the minimum/maximum values. The value must be `DAY` or `d`.                                                                                     |
| `value`                | `https://schema.org/Number` The exact number of handling days, if known. The value must be a non-negative, whole number. If provided, `minValue` and `maxValue` must not be specified. |
...
| Recommended properties |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `doesNotShip`          | `https://schema.org/Boolean` If applicable, set this to `true` if shipping from a location in the specified `shippingOrigin` to a location in the specified `shippingDestination` isn't available for orders with the specified combination of `weight`, `numItems`, and `orderValue` conditions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `numItems`             | `https://schema.org/QuantitativeValue` The range of the number of products in the order for this shipping conditions object, if applicable. See also the list of [`QuantitativeValue`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-quantitative-value-properties) properties related to the `ShippingConditions` type supported by Google.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `orderValue`           | `https://schema.org/MonetaryAmount` The range of the cost of the order for this shipping conditions object, if applicable. See also the list of [`MonetaryAmount`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-conditions-monetary-amount-properties) properties related to the `ShippingConditions` type supported by Google.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `shippingDestination`  | `https://schema.org/DefinedRegion` Indicates shipping destination, if applicable. See the list of [`DefinedRegion`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#defined-region-properties) properties under the `shippingDestination` property supported by Google.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `shippingOrigin`       | `https://schema.org/DefinedRegion` Indicates shipping origin, if applicable. See the list of [`DefinedRegion`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#defined-region-properties) properties under the `shippingOrigin` property supported by Google.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `seasonalOverride`     | `https://schema.org/OpeningHoursSpecification` If applicable, use this property to specify a limited time period for which this shipping conditions object is valid. See also the list of [`OpeningHoursSpecification`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-seasonal-override-properties) properties supported for the `ShippingConditions` type by Google. <br />                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `shippingRate`         | `https://schema.org/ShippingRateSettings` or `https://schema.org/MonetaryAmount` If applicable, use this property to specify the shipping cost for shipments from a location in the specified `shippingOrigin` to a location in the specified `shippingDestination` for orders with the specified combination of `weight`, `numItems`, and `orderValue` conditions. See also the list of [`ShippingRateSettings`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-rate-settings-properties) properties and [`MonetaryAmount`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-monetary-amount-properties) properties supported for the `ShippingConditions` type by Google. This property should only be specified if `doesNotShip` is absent or set to `false`. <br /> |
| `transitTime`          | `https://schema.org/ServicePeriod` If applicable, use to specify the expected transit time between leaving the shipping origin (typically a warehouse) and arriving at the shipping destination (typically the customer). Applies to shipments from a location in the specified `shippingOrigin` property to a location in the specified `shippingDestination` property for orders with the specified combination of `weight`, `numItems`, and `orderValue` conditions. See also the list of [`ServicePeriod`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-service-transit-time-properties) properties supported by Google. This property should only be specified if the `doesNotShip` property is absent or set to `false`. <br />                                                                              |
| `weight`               | `https://schema.org/QuantitativeValue` The package's weight range for this shipping conditions object, if applicable. See also the list of [`QuantitativeValue`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-quantitative-value-properties) properties related to the `ShippingConditions` type supported by Google.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Recommended properties |                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `addressRegion`        | `https://schema.org/Text` The country-specific region code, if applicable. The region must be a 2- or 3-character ISO 3166-2 subdivision code, without country prefix. Google Search only supports the US, Australia, and Japan. Examples: `NY` (for US, state of New York), `NSW` (for Australia, state of New South Wales), or `03` (for Japan, Iwate prefecture). Don't provide both a region and postal code information. |
| `postalCode`           | `https://schema.org/Text` The country-specific postal code, if applicable. For example, `94043`. Postal codes are supported for Australia, Canada, and the US.                                                                                                                                                                                                                                                                |
...
| Recommended properties |                                                                                                                                                                                                                                                                                                                         |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `businessDays`         | `https://schema.org/DayOfWeek` The days of the week when an order is an active transit, if applicable. If your organization's business days are Monday through Saturday, you don't need to add this property.                                                                                                           |
| `duration`             | `https://schema.org/QuantitativeValue` The number of business days in transit, if applicable. See also the list of [`QuantitativeValue`](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-quantitative-value-properties) properties for transit times supported by Google. |
...
| `maxValue`             | `https://schema.org/Number` The maximum number of days. The value must be a non-negative, whole number.                                                                               |
| `minValue`             | `https://schema.org/Number` The minimum number of days, if applicable. The value must be a non-negative, whole number.                                                                |
| `unitCode`             | `https://schema.org/Text` The transit time unit. The value must be `DAY` or `d`.                                                                                                      |
| `value`                | `https://schema.org/Number` The exact number of transit days, if known. The value must be a non-negative, whole number. If provided, `minValue` and `maxValue` must not be specified. |
...
| Recommended properties |                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `maxValue`             | `https://schema.org/Number` The maximum number for the dimension (`weight` or `numItems`), if applicable. Defaults to infinity when not provided.                                                                                                                                                                                              |
| `minValue`             | `https://schema.org/Number` The minimum number for the dimension (`weight` or `numItems`), if applicable. Must be less than `maxValue`. Defaults to 0 when not provided.                                                                                                                                                                       |
| `unitCode`             | `https://schema.org/Text` A unit relevant to the dimension (`weight` or `numItems`), if applicable. in UN/CEFACT Common Code (three characters) format: - For weight units, the value must be `LBR` (pound) or `KGM` (kilogram) - For number of items, `unitCode` can be omitted. Alternatively, you can use UN/CEFACT Common Code name `H87`. |
...
[specify shipping costs](https://developers.google.com/search/docs/appearance/structured-data/shipping-policy#shipping-monetary-amount-properties).

| Required properties |                                                                                                                               |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `currency`          | `https://schema.org/Text` The currency code for the order value in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) format. |
| `maxValue`          | `https://schema.org/Number` The maximum value of the order. Defaults to infinity when not provided.                           |
| `minValue`          | `https://schema.org/Number` The minimum value of the order. Defaults to 0 when not provided.                                  |
...
| Required properties |                                                                                                                                                                     |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `currency`          | `https://schema.org/Text` The currency code for the shipping cost in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) format.                                     |
| `maxValue`          | `https://schema.org/Number` The maximum shipping cost for the given shipping condition. If you specify the `maxValue` property, don't specify the `value` property. |
| `value`             | `https://schema.org/Number` The fixed shipping cost for the given shipping condition. For free shipping, use `0` as the value.                                      |
...
| Recommended properties |                                                                                                                                                                   |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `orderPercentage`      | `https://schema.org/Number` The shipping cost for the given shipping condition as a fraction of the order value. Use a value between `0` and `1`.                 |
| `weightPercentage`     | `https://schema.org/Number` The shipping cost for the given shipping condition as a fraction of the weight of the shipped goods. Use a value between `0` and `1`. |
...
| Recommended properties |                                                                                                                                              |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `validFrom`            | `https://schema.org/Date` The first date when the shipping condition is valid, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. |
| `validThrough`         | `https://schema.org/Date` The last date when the shipping condition is valid, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.  |
