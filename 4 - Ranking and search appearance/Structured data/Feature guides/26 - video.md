...
your video with [`VideoObject`](https://developers.google.com/search/docs/appearance/structured-data/video#video-object). Adding video structured data
...
Here's an example of [`VideoObject`](https://developers.google.com/search/docs/appearance/structured-data/video#video-object)
and [`Clip`](https://developers.google.com/search/docs/appearance/structured-data/video#clip).
...
Here's an example of a single [`VideoObject`](https://developers.google.com/search/docs/appearance/structured-data/video#video-object)
that includes the [additional properties](https://developers.google.com/search/docs/appearance/structured-data/video#seek) needed for `SeekToAction` markup.
...
If you're adding [`BroadcastEvent`](https://developers.google.com/search/docs/appearance/structured-data/video#broadcast-event) to livestream
...
![A video in search results with timestamps and labels](https://developers.google.com/static/search/docs/images/video-timestamps-on-youtube.png) **1. Label** : The name of the clip.  
...
If you're adding [`Clip`](https://developers.google.com/search/docs/appearance/structured-data/video#clip) or [`SeekToAction`](https://developers.google.com/search/docs/appearance/structured-data/video#seek)
...
You must include the required [`VideoObject`](https://developers.google.com/search/docs/appearance/structured-data/video#video-object) properties for your
...
user experience. In addition to [`VideoObject`](https://developers.google.com/search/docs/appearance/structured-data/video#video-object), you can add the
...
| Required properties |                                                                                                                                                                                                                                                                                                                                                  |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `name`              | `https://schema.org/Text` The title of the video. Make sure to use unique text in the `name` property for each video on your site.                                                                                                                                                                                                               |
| `thumbnailUrl`      | Repeated `https://schema.org/URL` A URL pointing to the video's unique thumbnail image file. Follow the [thumbnail image guidelines](https://developers.google.com/search/docs/appearance/video#valid-thumbnail).                                                                                                                                |
| `uploadDate`        | `https://schema.org/DateTime` The date and time the video was first published, in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601). We recommend that you provide timezone information; otherwise, we will default to [the timezone used by Googlebot](https://developers.google.com/search/docs/crawling-indexing/googlebot#timezone). |

| Recommended properties |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `contentUrl`           | `https://schema.org/URL` > [!NOTE] > We recommend that your provide the `contentUrl` property, if possible. This is the most effective way for Google to fetch your video content files. If `contentUrl` isn't available, provide `embedUrl` as an alternative. A URL pointing to the video file's actual content bytes, in one of the [supported file types](https://developers.google.com/search/docs/appearance/video#supported-video-files). Don't link to the page where the video lives; this must be the URL of the video file's actual content bytes itself. `"contentUrl": "https://www.example.com/video/123/file.mp4"` Make sure to follow our [video best practices](https://developers.google.com/search/docs/appearance/video). > [!TIP] > **Tip** : You can ensure that only Googlebot accesses your content by using a [reverse DNS lookup](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot). |
| `description`          | `https://schema.org/Text` The description of the video. Make sure to use unique text in the `description` property for each video on your site. HTML tags are ignored.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `duration`             | `https://schema.org/Duration` The duration of the video in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601#Durations). For example, `PT00H30M5S` represents a duration of "thirty minutes and five seconds".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `embedUrl`             | `https://schema.org/URL` > [!NOTE] > We recommend that your provide the `contentUrl` property, if possible. This is the most effective way for Google to fetch your video content files. If `contentUrl` isn't available, provide `embedUrl` as an alternative. A URL pointing to a player for the specific video. Don't link to the page where the video lives; this must be the URL of the video player itself. Usually this is the information in the `src` attribute of an `<embed>` element. `"embedUrl": "https://www.example.com/embed/123"` Make sure to follow our [Video best practices](https://developers.google.com/search/docs/appearance/video). > [!TIP] > **Tip** : You can ensure that only Googlebot accesses your content by using a [reverse DNS lookup](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot).                                                                               |
| `expires`              | `https://schema.org/DateTime` If applicable, the date and time after which the video will no longer be available, in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601). Don't supply this information if your video does not expire. We recommend that you provide timezone information; otherwise, we will default to [the timezone used by Googlebot](https://developers.google.com/search/docs/crawling-indexing/googlebot#timezone).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `hasPart`              | If your video has important segments, nest the [required `Clip` properties](https://developers.google.com/search/docs/appearance/structured-data/video#clip) in your `VideoObject`. For example: `<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "VideoObject", "name": "Cat video", "hasPart": { "@type": "Clip", "name": "Cat jumps", "startOffset": 30, "url": "https://www.example.com/example?t=30" } } </script>`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `ineligibleRegion`     | `https://schema.org/Place` The region where the video isn't allowed, if applicable. If not specified, then Google assumes the video is allowed everywhere. Specify the countries in [two- or three-letter ISO 3166-1 format](https://en.wikipedia.org/wiki/ISO_3166-1). For multiple values, use multiple country codes (for example, a JSON-LD array or multiple `meta` tags in Microdata). > [!NOTE] > We also support the [`regionsAllowed`](https://developers.google.com/search/docs/appearance/structured-data/video#regions-allowed) property. Add either `ineligibleRegion` or `regionsAllowed`, whichever makes sense for your site.                                                                                                                                                                                                                                                                                                 |
| `interactionStatistic` | `https://schema.org/InteractionCounter` The number of times the video has been watched. For example: `"interactionStatistic": { "@type": "InteractionCounter", "interactionType": { "@type": "WatchAction" }, "userInteractionCount": 12345 }` > [!NOTE] > Starting October 2019, we changed our documentation to recommend `interactionStatistic` instead of `interactionCount`. While we continue to support `interactionCount`, we recommend `interactionStatistic` moving forward.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `publication`          | If your video is happening live and you want to be eligible for the LIVE badge, nest the [`BroadcastEvent` properties](https://developers.google.com/search/docs/appearance/structured-data/video#broadcast-event) in your `VideoObject`. For example: `<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "VideoObject", "name": "Cat video", "publication": { "@type": "BroadcastEvent", "name": "First scheduled broadcast", "isLiveBroadcast": true, "startDate": "2018-10-27T14:00:00+00:00", "endDate": "2018-10-27T14:37:14+00:00" } } </script>`                                                                                                                                                                                                                                                                                                                                                       |
| `regionsAllowed`       | `https://schema.org/Place` The regions where the video is allowed, if applicable. If not specified, then Google assumes the video is allowed everywhere. Specify the countries in [two- or three-letter ISO 3166-1 format](https://en.wikipedia.org/wiki/ISO_3166-1). For multiple values, use multiple country codes (for example, a JSON-LD array or multiple `meta` tags in Microdata). > [!NOTE] > We also support the [`ineligibleRegion`](https://developers.google.com/search/docs/appearance/structured-data/video#ineligible-region) property. Add either `ineligibleRegion` or `regionsAllowed`, whichever makes sense for your site.                                                                                                                                                                                                                                                                                               |

### `BroadcastEvent`

To be eligible for display with a LIVE badge, nest the following
properties in your [VideoObject](https://developers.google.com/search/docs/appearance/structured-data/video#video-object). While
...
| Required properties           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `publication`                 | `https://schema.org/BroadcastEvent` Describes when the video is to be streamed live. Can be a list or a single instance.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `publication.endDate`         | `https://schema.org/DateTime` Time and date of when the livestream ends or is expected to end, in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601). It's required to provide the `endDate` once the video has finished and is no longer live. If the expected `endDate` is unknown prior to the livestream starting, we recommend providing an approximate `endDate`. If `endDate` is in the past or present, it indicates stream actually ended and is no longer live. If `endDate` is in the future, it indicates stream is scheduled to end at that time. |
| `publication.isLiveBroadcast` | Boolean Set to `true` if the video is, has been, or will be streamed live.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `publication.startDate`       | `https://schema.org/DateTime` Time and date of when the livestream starts or is expected to start, in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601). If `startDate` is in the past or present, it indicates that the stream actually started. If `startDate` is in the future, it indicates stream is scheduled to start at that time.                                                                                                                                                                                                                    |
...
| Required properties |                                                                                                                                                                                                                                                                                                                     |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`              | `https://schema.org/Text` A descriptive title for the content of the clip.                                                                                                                                                                                                                                          |
| `startOffset`       | `https://schema.org/Number` The start time of the clip expressed as the number of seconds from the beginning of the work.                                                                                                                                                                                           |
| `url`               | `https://schema.org/URL` A URL that points to the start time of the clip. The clip URL must point to the same URL path as the video with additional query parameters that specify the time. For example, the following URL means the video starts at 2:00 minutes: `"url": "https://www.example.com/example?t=120"` |

| Recommended properties |                                                                                                                         |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `endOffset`            | `https://schema.org/Number` The end time of the clip expressed as the number of seconds from the beginning of the work. |
...
| Required properties                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `potentialAction`                   | `https://schema.org/SeekToAction` Indicates a potential action. Include the following nested properties - [`potentialAction.startOffset-input`](https://developers.google.com/search/docs/appearance/structured-data/video#start-offset-input) - [`potentialAction.target`](https://developers.google.com/search/docs/appearance/structured-data/video#target) For example: `{ "@context": "https://schema.org", "@type": "VideoObject", "potentialAction" : { "@type": "SeekToAction", "target": "https://video.example.com/watch/videoID?t={seek_to_second_number}", "startOffset-input": "required name=seek_to_second_number" } }`                          |
| `potentialAction.startOffset-input` | `https://schema.org/Text` The placeholder string that Google will identify as your timestamp structure and then replace with the number of seconds to skip to. Use the following value: `"startOffset-input": "required name=seek_to_second_number"` `startOffset-input` is an annotated property. See the [`Potential Actions`](https://schema.org/docs/actions.html#part-4) page for more information.                                                                                                                                                                                                                                                        |
| `potentialAction.target`            | `https://schema.org/EntryPoint` The URL of the page that contains this `VideoObject`, including a placeholder in the URL structure that indicates where Google can insert the number of seconds to skip to in the video. This is how Google understands your URL structure and how you format your timestamps. Replace the timestamp part of the URL with the following placeholder string: `{seek_to_second_number}` For example, replace the timestamp part of the URL: `"target": "https://video.example.com/watch/videoID?t=30"` So that the timestamp now looks like this: `"target": "https://video.example.com/watch/videoID?t={seek_to_second_number}"` |
