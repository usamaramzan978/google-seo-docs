...
- To keep Google informed of changes, we recommend that you [submit a sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/build-sitemap). You can automate this with the [Search Console Sitemap API](https://developers.google.com/webmaster-tools/search-console-api-original/v3/sitemaps).
...
1. Add the [required properties](https://developers.google.com/search/docs/appearance/structured-data/image-license-metadata#structured-data-type-definitions). Based on the format you're using, learn where to [insert
...
5. To keep Google informed of future changes, we recommend that you [submit a sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/build-sitemap). You can automate this with the [Search Console Sitemap API](https://developers.google.com/webmaster-tools/search-console-api-original/v3/sitemaps).
...
| Required properties                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `contentUrl`                                                       | `https://schema.org/URL` A URL to the actual image content. Google uses `contentUrl` to determine which image the photo metadata applies to. > [!NOTE] > Google also supports the `url` property to specify the image URL if you don't include `contentUrl`. While the `url` property is not as precise and we recommend you use `contentUrl` instead, existing markup may still use `url`.                                                                                                                                                                                                                                                                                                                      |
| Either `creator` or `creditText` or `copyrightNotice` or `license` | In addition to `contentUrl`, you must include one of the following properties: - [`creator`](https://developers.google.com/search/docs/appearance/structured-data/image-license-metadata#creator-sd) - [`creditText`](https://developers.google.com/search/docs/appearance/structured-data/image-license-metadata#credit-sd) - [`copyrightNotice`](https://developers.google.com/search/docs/appearance/structured-data/image-license-metadata#copyright-sd) - [`license`](https://developers.google.com/search/docs/appearance/structured-data/image-license-metadata#license-sd) > [!NOTE] > Once you include one of these properties, the other three properties become recommended in the Rich Results Test. |

| Recommended properties |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `acquireLicensePage`   | `https://schema.org/URL` A URL to a page where the user can find information on how to license that image. Here are some examples: - A check-out page for that image where the user can select specific resolutions or usage rights - A general page that explains how to contact you                                                                                                                                                                                                                                                                                                      |
| `creator`              | `https://schema.org/Organization` or `https://schema.org/Person` The creator of the image. This is usually the photographer, but it may be a company or organization (if appropriate).                                                                                                                                                                                                                                                                                                                                                                                                     |
| `creator.name`         | `https://schema.org/Text` The name of the creator.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `creditText`           | `https://schema.org/Text` The name of the person and/or organization that is credited for the image when it's published.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `copyrightNotice`      | `https://schema.org/Text` The copyright notice for claiming the intellectual property for this photograph. This identifies the current owner of the copyright for the photograph.                                                                                                                                                                                                                                                                                                                                                                                                          |
| `license`              | `https://schema.org/URL` A URL to a page that describes the license governing an image's use. For example, it could be the terms and conditions that you have on your website. Where applicable, it could also be a Creative Commons License (for example, [BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/)). If you're using structured data to specify an image, you must include the `license` property for your image to be eligible to be shown with the Licensable badge. We recommend that you also add the `acquireLicensePage` property if you have that information. |
...
> [!IMPORTANT]
> **Important** : Google does not guarantee that structured data or IPTC photo metadata will show up in search results. For a list of common reasons why Google may not show structured data in search results, see the [General Structured Data Guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies).
...
- Review the [guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies) again to identify if your content isn't compliant with the guidelines.
