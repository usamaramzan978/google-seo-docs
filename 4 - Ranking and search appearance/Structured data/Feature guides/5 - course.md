...
that contains the [`ItemList` markup](https://developers.google.com/search/docs/appearance/structured-data/course#item-list).
...
- NoPromotional phrases: "Best school in the world"
- NoPrices in course titles: "Learn ukulele - only $30!"
- NoUsing something other than a course for a title, such as: "Make money fast with this class!"
- NoDiscounts or purchase opportunties, such as: "Leaders in their fields share their secrets --- 25% off!"
...
| Required properties |                                                                                        |
| ------------------- | -------------------------------------------------------------------------------------- |
| `description`       | `https://schema.org/Text` A description of the course. Display limit of 60 characters. |
| `name`              | `https://schema.org/Text` The title of the course.                                     |

| Recommended properties |                                                                                                                               |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `provider`             | `https://schema.org/Organization` The organization that publishes the source content of the course. For example, UC Berkeley. |

### `ItemList`

In addition to [`Course` properties](https://developers.google.com/search/docs/appearance/structured-data/course#course), add the following
...
| Required properties |                                                                                                 |
| ------------------- | ----------------------------------------------------------------------------------------------- |
| `itemListElement`   | `https://schema.org/ListItem` Annotation for a single item page.                                |
| `ListItem.position` | `https://schema.org/Integer` Ordinal position of the item page in the list.                     |
| `ListItem.url`      | `https://schema.org/URL` The canonical URL of the item page. Every item must have a unique URL. |
