...
| `site:` examples                                       |                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `site:example.com`                                     | Returns a list of indexed and serving URLs. > [!NOTE] > The list of URLs returned is not always exhaustive. Bigger sites shouldn't expect to see all their URLs in the results. A more specific prefix in the query may yield more results than broader prefixes. |
...
[Video](https://www.youtube.com/watch?v=SgrDKE7xcEk)
