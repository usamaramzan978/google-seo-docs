...
[Video](https://www.youtube.com/watch?v=ViwW9D-brTQ)
...
|---|---|
| **Search Console Clicks** A _[click](https://support.google.com/webmasters/answer/7042828#click)_ happens when a person clicks on a link in a Google Search result leading to your website. | **Google Analytics Sessions** A _[session](https://support.google.com/analytics/answer/9191807)_ is a period of time during which a user interacts with your website or app. |
...
[Video](https://www.youtube.com/watch?v=3ezmohvavzI)
...
2. **Country and device** : Include or exclude countries and device categories.
   ...
   > filter for both data sources**. So if you're filtering Search Console to mobile devices in Australia, be sure to change your Google Analytics filters too.
...
| **2. Engagement rate** (Google Analytics)        | The percentage of sessions that engage with your content. An engaged session is one that meets any of the following criteria: - A session that had a _[key event](https://support.google.com/analytics/answer/9355848)_ - A session that lasted longer than 10 seconds - A session that had 2 or more page views Learn more [about engagement rate](https://support.google.com/analytics/answer/11109416).                                |
...
- **[Landing page report](https://support.google.com/analytics/answer/12931766)
  with a filter to include only sessions from google organic**: This gives you an idea of how useful the page is to your organic traffic, and also how well the page does in terms of driving engagement and conversions on your website.
