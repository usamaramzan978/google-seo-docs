...
3. Make your content [discoverable by linking your pages](https://www.ampproject.org/docs/guides/discovery). For crawling and indexing, Google Search requires that an AMP page links to a [canonical page](https://developers.google.com/search/docs/crawling-indexing/consolidate-duplicate-urls). The canonical page can be either a non-AMP version of the page or it can be the AMP page itself.
...
6. Use the same [structured data markup](https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data) across both the canonical and AMP pages.
7. Apply common content best practices:
   1. Make sure that your [robots.txt file](https://developers.google.com/search/docs/crawling-indexing/robots/robots_txt) doesn't block your AMP page. Use [robots `meta` tags,
   ...
   2. Follow the guidelines for [hreflang for language and regional URLs](https://developers.google.com/search/docs/specialty/international/localized-versions). For AMP specific examples, see [Internationalization](https://amp.dev/documentation/examples/guides/internationalization/).
...
customize your CMS, follow these guidelines in addition to [Create a basic AMP page](https://developers.google.com/search/docs/crawling-indexing/amp/enhance-amp#create-basic-amp):
